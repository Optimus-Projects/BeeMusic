...
from Bumble.Database import (_get_playlists, delete_playlist, get_playlist,
                            get_playlist_names, is_active_chat, save_playlist)
from Bumble.Database.queue import (add_active_chat, is_active_chat,
                                  is_music_playing, music_off, music_on,
                                  remove_active_chat)
from Bumble.Decorators.admins import AdminRightsCheckCB
from Bumble.Decorators.checker import checkerCB
from Bumble.Inline import (audio_markup, audio_markup2, download_markup,
...
from Bumble.Utilities.paste import isPreviewUp, paste_queue
...
async def admin_risghts(_, CallbackQuery):
    ...
    if command == "resumecb":
        ...
        await Bumble.pytgcalls.resume_stream(chat_id)
        await CallbackQuery.message.reply_text(
    ...
    if command == "stopcb":
        ...
        await Bumble.pytgcalls.leave_group_call(chat_id)
        await CallbackQuery.message.reply_text(
